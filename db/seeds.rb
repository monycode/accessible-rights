...
question_9 = Question.create!(
  ...
  content: "I have a bonus that was supposed to be paid out on or by 1/30/19. I have it in writing. I was verbally told I should receive it for the past two months and it hasn't shown up yet. I have a new position lined up but I am worried I wont get the bonus if I leave before it's paid. The bonus is for performance in 2018. The contract says if either party terminates employment the contract is void. If I quit am I still entitled to the bonus being that it's past due? How should I go about telling my boss that I’m leaving to not ruin my case? (Wisconsin)",
